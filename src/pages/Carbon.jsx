...
function Carbon({ name, apiURL }) {
    const { isLoading, error, data } = useQuery('project', () => fetch(apiURL).then(res => res.json()));
                ...
                <Box bg='white' p={4} borderWidth='1px' borderRadius='lg'>
                    <YMaps>
                        <Map defaultState={{
                            ...
                            <Placemark geometry={[43.251890652055764, 45.7797947867823]} properties={{ iconCaption: "WayCarbon" }} />
                        </Map>
                    </YMaps>
                </Box>
            </Box>
